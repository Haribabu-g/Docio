  ...
  return (
    <div className="bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-18">
              ...
              <p className="text-muted-foreground text-xl md:text-2xl space-y-6 max-w-md">
            ...
            <div className="relative h-[400px] sm:h-[500px] md:h-[600px] lg:h-[880px] rounded-xl overflow-hidden">
              <Image
                src="/banner007.png"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-emerald-900/30 bg-emerald-700/30 px-4 py-2 text-emerald-400 text-sm font-medium mb-4">
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  ...
                  journey with our Docio platform. Get started today and
